  ...
  return (
    <>
      <div className="pt-30 bg-primary">
        ...
        <div className="min-h-screen mt-6 bg-primary text-white p-4 md:p-8">
          {/* Header */}
              ...
              <div className="bg-zinc-900 rounded-lg p-6 border border-zinc-800">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pb-4 border-b border-zinc-800">
                    ...
                    <p className="text-sm">
                      {currentPlan.features.cancelAnytime}
                    </p>
                  </div>
                  ...
                  <div className="pb-4 border-b border-zinc-800">
                    ...
                    <p className="text-sm">
                      {currentPlan.features.offlineViewing}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      {currentPlan.features.familySharing}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-zinc-900 rounded-lg border border-zinc-800 overflow-hidden">
              <div className="grid grid-cols-4">
                ...
                {plans.map((plan) => (
                  <div
                    key={plan.name}
                    className="p-6 border-b border-zinc-800 border-r last:border-r-0"
                  >
                ...
                {featureLabels.map((feature, idx) => (
                  <React.Fragment key={feature.key}>
                    <div
                      className={`p-6 border-r border-zinc-800 ${
                        idx < featureLabels.length - 1 ? "border-b" : ""
                      }`}
                    >
                    ...
                    {plans.map((plan, planIdx) => (
                      <div
                        ...
                        className={`p-6 border-r last:border-r-0 border-zinc-800 ${
                          idx < featureLabels.length - 1 ? "border-b" : ""
                        }`}
                      >
